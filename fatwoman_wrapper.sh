...
runLLM_Finnhub()     { /usr/bin/python3 ${BASE_DIR}Scripts_LLM_trader/db/FinnHub.py;}
runLLM_newsapiorg()  { /usr/bin/python3 ${BASE_DIR}Scripts_LLM_trader/db/newsapiorg.py;}
